...
class Registration extends Component {
  ...
  render() {
    return (
      <Form ref={c => { this.form = c }} onSubmit={this.handleSubmit} style={{font-family: Arial}}>
        <div className="row">
...
class Comment extends Component {
  handleSubmit = (event) => {
    ...
    setTimeout(() => {
      this.form.showError(this.userInput, <span className="form-error is-visible">Server not found</span>);
    }, 1000);
  };
  ...
  render() {
    return (
      <Form onSubmit={this.handleSubmit} ref={c => this.form = c}>
        ...
        <div className="row">
          <div className="small-12 medium-6 columns">
            <Button style={{color: "darkgrey"}} className="button">Submit</Button>
          </div>
        </div>
      </Form>
    )
